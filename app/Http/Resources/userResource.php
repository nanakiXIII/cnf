...
class userResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'permission' => $tab,
            'telechargement' => downloadResource::collection($this->download()->where('user_id', $this->id)->where('qualite', 'hd')->orWhere('qualite', 'dvd')->orWhere("qualite", 'fhd')->orderBy('id', 'DESC')->groupBy('episode_id')->get()),
