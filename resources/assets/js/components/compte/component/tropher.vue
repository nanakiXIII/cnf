<template>
    <div class="row" v-if="user.data != undefined">
        <div class="col-md-12" v-show="user.data.lecture.length > 0">
            <ul class="list-unstyled" style="width:100%">
                <li class="media mb-2 bg-white p-2" style="width:100%;box-shadow: 1px 1px 5px #555;"  v-for="episode in user.data.lecture">
                    ...
                    <div class="row media-body">
                        ...
                        <div class="col-md-2 align-self-center text-center">
                            <router-link v-if="!episode.episode.Erreur" :to="{name:'lecture', params:{type:episode.serie.type, slug:episode.serie.slug,  saison: episode.saison.numero, episode: episode.episode.numero }}" type="button" class="btn btn-outline-secondary">Reprendre la lecture</router-link>
                        </div>
                    </div>
                </li>
            </ul>
